$(function() {
    ...
    var paperfold = $('#paper_content_1').paperfold();
    var paperfold1 = $('#paper_content_2').paperfold();

    $('.paperfold-toggle1').click(paperfold.toggle);
    $('.paperfold-toggle2').click(paperfold1.toggle);
...
var demo = Sketch.create({
	container: document.getElementById( 'for_particles' )
});
...
demo.mousemove = function() {
	...
	for ( i = 0, n = demo.touches.length; i < n; i++ ) {
		...
		for ( j = 0; j < max; j++ ) demo.spawn( touch.x+150, touch.y+50 );
	}
};
